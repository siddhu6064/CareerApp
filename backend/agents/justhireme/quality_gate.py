# ============================================================================
# Origin: JustHireMe — https://github.com/vasu-devs/justhireme
# File:   backend/agents/quality_gate.py
# Author: Vasudev Siddh
# License: MIT (Copyright (c) 2026 Vasudev Siddh) — see LICENSE-justhireme
#
# Imported into [AppName] as a portable module. See docs/PORT_NOTES.md for
# the multi-tenant adaptations required before integrating into /backend.
# ============================================================================
...
from .lead_intel import clean_text, signal_quality
