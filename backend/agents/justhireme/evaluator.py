...
#
# REFERENCE ONLY — do not import wholesale. Lift the _SYSTEM_PROMPT seniority
# caps (lines ~50–60) into our Sonnet tailor system prompt. Replace the rest
# with a direct call to scoring_engine.score_job_lead() + our Sonnet path.
# ============================================================================
